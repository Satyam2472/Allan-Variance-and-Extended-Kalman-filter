...
Original file is located at
    https://colab.research.google.com/drive/1vhPhUyOqndivbuOgfmfVN1Fy_ZncTwnD
"""
...
"""# Note that we find the ALLAN VAIANCE using only GyX 
...
def generate_signal(n, dt, q_white, q_walk, q_ramp, random_state=0):
    rng = np.array(m)
    white = q_white * rng * dt ** 0.5
    walk = q_walk * dt ** 0.5 * rng    
    ramp = q_ramp * dt * np.arange(n)
    return white + walk * dt + ramp * dt

dt = 1e-2

x = generate_signal(14447, dt, 0.1, 0.05, 0.002)
